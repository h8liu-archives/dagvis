...
(function() {
  ...
  main = function() {
    var b, boxHeight, boxWidth, boxof, cmpNode, dat, esc, fromx, fromy, hoverFunc, hy, lab, layout, lightIns, lightOuts, node, nodes, output, p, path, pathof, paths, svg, toNode, tox, toy, turnx, xgrid, xpush, ygrid, _i, _j, _k, _len, _len1, _len2, _ref;
    xgrid = 130;
    ygrid = 30;
    boxWidth = 120;
    boxHeight = 20;
